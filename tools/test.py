...
def parse_args():
    ...
    parser.add_argument('--corr', help='checkpoint file')
    parser.add_argument('--severity_level', help='checkpoint file')
...
def main():
    ...
    cfg.data.test.corr = args.corr
    cfg.data.test.severity_level = args.severity_level
    ...
    if not distributed:
        ...
        # outputs = single_gpu_test(model, data_loader, args.show, './show_1654')
