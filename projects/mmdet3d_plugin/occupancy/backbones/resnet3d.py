...
class BasicBlock7x7(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=None, norm_cfg=dict(type='BN3d', requires_grad=True)):
        super().__init__()

        # self.conv1 = conv3x3x3(in_planes, planes, stride)
        self.conv1 = conv7x7x7(in_planes, planes)
        # self.bn1 = build_norm_layer(norm_cfg, planes)[1]
        self.relu = nn.ReLU(inplace=True)
        # self.conv2 = conv5x5x5(planes, planes)
