...
class CompletionBranch(nn.Module):
    ...
    def forward_once(self, inputs):
        ...
        return dict(
            mss_bev_dense = [bev_1, bev_2, bev_3],
            logits_2 = logits_2.permute(0, 1, 4, 3, 2)
        )
    ...
    def forward(self, data_dict, example):
        if self.phase == 'trainval':
            ...
            focal_loss_1_2 = F.binary_cross_entropy(teacher_2.squeeze(1).sigmoid()[sc_label_1_2_copy!=255], sc_label_1_2_copy[sc_label_1_2_copy!=255].float())
            ...
            loss = {"1_2_bce_loss": focal_loss_1_2}
            ...
            focal_loss_1_4 = F.binary_cross_entropy(teacher_4.squeeze(1).sigmoid()[sc_label_1_4_copy!=255], sc_label_1_4_copy[sc_label_1_4_copy!=255].float())

            # scale_loss_1_2 = lovasz_softmax(F.softmax(teacher_2, dim=1), sc_label_1_2_copy, ignore=255)
            # focal_loss_1_2 = F.cross_entropy(teacher_2, sc_label_1_2_copy, ignore_index=255)
            loss.update({"1_4_bce_loss": focal_loss_1_4}) 
            ...
            focal_loss_1_8 = F.binary_cross_entropy(teacher_8.squeeze(1).sigmoid()[sc_label_1_8_copy!=255], sc_label_1_8_copy[sc_label_1_8_copy!=255].float())

            # scale_loss_1_2 = lovasz_softmax(F.softmax(teacher_2, dim=1), sc_label_1_2_copy, ignore=255)
            # focal_loss_1_2 = F.cross_entropy(teacher_2, sc_label_1_2_copy, ignore_index=255)
            loss.update({"1_8_bce_loss": focal_loss_1_8}) 
            return dict(
